...
<div class="container-fluid px-4">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <a class="card card-icon lift lift-sm h-100" href="{{ route('produsen.show-produk', $item->id_pesanan) }}">
                <div class="row g-0 h-100">
                    ...
                    <div class="col">
                        <div class="card-body py-4">
                            ...
                            <p class="card-text mb-1">Status : {{ $item->status_pesanan }}</p>
                        </div>
                    </div>
                </div>
            </a>
        ...
        @empty
        <p class="text-center m-auto">Tidak ada pesanan</p>
        @endforelse
    </div>
