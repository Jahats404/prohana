    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <div>
                    {{-- <img src="{{ asset('storage/produk/' . $pesanan->detail_pesanan->detail_produk->produk->foto_produk) }}" alt="Foto Produk" style="max-width: 100%;"> --}}
                </div>
            </div>
            <div class="form-group">
                <label class="form-label">Nama Produk:</label>
                <p>{{ $pesanan->detail_pesanan->detail_produk }}</p>
            </div>
            <div class="form-group">
