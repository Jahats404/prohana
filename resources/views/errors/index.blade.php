...
<body>
    ...
    <div class="error">
        <div class="error__title">{{ $status }}</div>
        <div class="error__subtitle">Hmmm...</div>
        <div class="error__description">{{ $message }}</div>
        <button class="error__button error__button--active" onclick="history.back()">GO BACK</button>
        <button class="error__button" onclick="window.location.href='/contact'">CONTACT</button>
    </div>
