<div class="modal fade" id="modalPengembalian{{ $item->id_garansi }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form class="user" action="{{ route('distributor.pengembalian', Crypt::encrypt($item->id_garansi)) }}" method="POST">
                @csrf
                @method('put')
                <div class="modal-header">
                    ...
                    <input value="Pengembalian" name="jenis_pengiriman" id="" hidden>
